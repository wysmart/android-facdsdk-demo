package com.weiyuan.util.camera;
    ...
    public void start() {
        synchronized (this) {
            ...
            try {
                ...
                Log.e(TAG, "fps:" + CurPreRange);

                List<Integer> pictureFormats = mCamera.getParameters().getSupportedPreviewFormats();
                for (int i = 0; i <  pictureFormats.size(); ++i)
                {
                    Log.e(TAG, "support format:" + pictureFormats.get(i));
                }
