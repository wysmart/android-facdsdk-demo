...
import com.weiyuan.widget.ProgressDialog;
...
public class FaceManageActivity extends BaseActivity {
    ...
    //注册图所在的目录
    private static final String ROOT_DIR = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "wyfacedemo";
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < totalCount; i++) {
                    ...
                    boolean success = faceServer.registerBgr24(FaceManageActivity.this, bgr24, bitmap.getWidth(), bitmap.getHeight(),
